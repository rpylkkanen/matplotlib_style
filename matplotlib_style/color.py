...
# Material colors obtained from url below:
# https://github.com/rougier/scientific-visualization-book/blob/master/code/colors/colored-hist.py
...
nanoscope = LinearSegmentedColormap("nanoscope", cdict)